...
# Formulario secuencial continuo
...
if submit_button:
    ...
    # Ajuste para igualar el valor de tu celda de resultados (0.067353)
    ...
    # ==========================================================================
    # DESPLIEGUE LINEAL CONTINUO
    # ==========================================================================
    st.markdown("---")
    st.markdown("### [ DATOS DE LOS COMPONENTES ]")
