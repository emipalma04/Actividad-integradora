...
with st.form("simulador_form"):
    ...
    x2_input = st.number_input("Concentración de $CO_2$ en el líquido de entrada en la parte superior ($x_2$, mol CO₂/mol sol)", min_value=0.0, max_value=0.9999, value=0.0580, format="%.4f")
